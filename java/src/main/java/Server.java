        ...
        while(fcgiInterface.FCGIaccept() >= 0) {
            ...
            if (method.equals("GET")) {
                ...
                if (!Objects.equals(req, "")) {
                    ...
                    boolean isValid;
                    try {
                        isValid = v.check(Double.parseDouble(m.get("x")), Float.parseFloat(m.get("y")), Double.parseDouble(m.get("r")));
                        isShot = checker.hit(Double.parseDouble(m.get("x")), Float.parseFloat(m.get("y")), Double.parseDouble(m.get("r")));
                    } catch (Exception e){
